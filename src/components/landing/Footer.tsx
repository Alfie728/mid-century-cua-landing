...
export function Footer() {
  return (
    <footer className="group bg-slate-50 pt-20 pb-10 border-t border-slate-200 font-sans relative overflow-hidden">
      ...
      <div className="absolute -top-1/4 left-1/3 -translate-x-1/2 w-[800px] h-[400px] bg-[#3AAFFF]/15 rounded-full blur-[100px] pointer-events-none -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out" />
